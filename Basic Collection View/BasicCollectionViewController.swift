...
class BasicCollectionViewController: UICollectionViewController {
    ...
    private let items = ["Tamil Nadu","Maharashtra","Punjab","Telangana","Assam","Madhya Pradesh","Uttar Pradesh","Karnataka","Kerala","Rajasthan","Bihar","Haryana","Gujarat","Jammu and Kashmir","Chattisgarh","Jharkhand","Arunachal Pradesh"]
